...
FTRAIN = '/Users/filipgulan/Diplomski/RASPUZ/proj/training.csv'
FTEST = '/Users/filipgulan/Diplomski/RASPUZ/proj/test.csv'
FLOOKUP = '/Users/filipgulan/Diplomski/RASPUZ/proj/IdLookupTable.csv'
...
def load(test=False, cols=None):
    ...
    if not test:  # only FTRAIN has any target columns
        ...
        y = (y - 48) / 48  # scale target coordinates to [-1, 1]        X, y = shuffle(X, y, random_state=42)  # shuffle train data
...
def fit():
    X, y = load2d()
    net2.fit(X, y)
    with open('net_new_ct.pickle', 'wb') as f:
